...
const names = people.map((item, index, array) => item.name + index);
console.log(names);
...
const heights = [170, 90, 185, 198, 162, 187, 155, 178, 207, 201, 189];
const a = heights.filter((item, index, array) => item > 100);
console.log(a);
/* 
...
const aa = letters.sort();
console.log(aa);

const numbers2 = [10, 55, 2, 250, 500, 85];
const newLocal = numbers2.sort((a, b) => a - b);
...
const newLocalq = store.sort((t, b) => t.price - b.price);
console.log(newLocalq);
